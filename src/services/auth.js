...
export const loginUser = async (payload) => { const user = await UsersCollection.findOne({ email: payload.email });
...
export const requestResetToken = async (email) => {
  ...
  await sendEmail({
    ...
    html: `<p>Click <a href="${resetToken}">here</a> Resset your password!</p>`,
  });
};
